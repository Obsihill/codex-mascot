...
**완료 팝업을 클릭할 때까지 유지**는 기본으로 켜져 있습니다. 캐릭터를 클릭하면 즉시 닫힙니다. 해당 도구의 데스크톱 창이 활성화되면 표시 시간(기본 4초, 0도 4초)이 지난 뒤 자동으로 닫힙니다. 같은 작업에서 다음 응답이 시작되어도 미확인 완료 알림을 유지합니다. 확인/승인 알림은 시간 제한 없이 유지하고 클릭 통과를 해제하여 누를 수 있게 합니다. 알림을 닫아도 실제 승인 대기 상태는 유지됩니다. 캐릭터에 별도 × 버튼은 없습니다.
